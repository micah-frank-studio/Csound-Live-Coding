...
schedule("forest", 0,4,5) ;5
schedule("elemental", 0, 10, 3) 	;1
schedule("spindle", 0, 4.5, 7, 0.52) 	;6
schedule("earth", 0, 5.2, 75)	;p4=freq
schedule("magnesium", 0,1.25,160)  	;p4 = freq
...
;	if sometimes(0.8, 1, 0) == 1 then
	...
	kamp=expseg(iampsus, p3, 0.001)
	irand=random(40, 170)
	ilambda=exprand(400)
	irand2=10+ilambda
	kmod = linseg(100, p3, 100) ;create random modulator for VCO freq
	ipw =random(0.05, 0.93)
	amodfreq =vco2(0.5,kmod,12) 
