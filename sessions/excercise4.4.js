...
//shape([30, 7, 9].fast(9.0)).modulateScale(osc(10)).out(o3)
    src(s3)
        ...
        //.blend(o1, 0.9)
        .add(o1)
        .modulatePixelate(osc(0.2,0.1,10),700)
        .modulateScale(osc(0.1,3,0),1)
        //.repeatX(Math.sin(time)*0.1, 1)
        //.brightness(()=>bright)
        //.add(osc([0.1,0.01,300].fast(0.1)))
        .mask(shape([20,4].fast(0.2)).modulateScale(osc(()=>modosc)).repeatX(()=>loop*Math.sin(4)))
      .out(o3)
